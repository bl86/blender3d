...
def main():
    ...
    print("  • Treble key first, then A-L-T-E-R letters")
    print("  • BANJA LUKA text comes last")
    print("  • Each element holds as next one arrives")
    print()
    print("⏱️  Estimated time: ~3-5 minutes (more elements to bake)")
    print()
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("   • Elements build up to complete logo")
            print("   • BANJA LUKA appears at the end")
