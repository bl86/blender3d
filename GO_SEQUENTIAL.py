...
def main():
    ...
    print()
    print("=" * 70)
    print("  STARTING SEQUENTIAL ANIMATION GENERATION (V3)")
    print("=" * 70)
    print()
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("      → Fire from start, extinguishes in last 2 seconds, logo glows")
            print()
